        ...
        $(document).on('click', '#btnSave', function (event) {
            ...
            $.post(actionUrl, dataToSend).done(function (data) {
                ...
                <div class="media mb-4">
                    <img class="d-flex mr-3 rounded-circle" src="https://randomuser.me/api/portraits/men/36.jpg" alt="">
                    ...
                    toastr.success(`Sayın ${commentAddAjaxModel.CommentDto.Comment.CreatedByName} yorumunuz başarıyla eklenmiştir. Bir
                    örneği sizler için karşınıza gelecek. Fakat yorumunuz onaylandıktan sonra görünür olacaktır.`);
